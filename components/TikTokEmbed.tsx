    ...
    return (
      <div className="h-[600px] bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
        <div className="text-center p-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Video tidak tersedia</p>
          <a 
            href={sourceUrl} 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm underline mt-2 inline-block"
          >
            Lihat di TikTok
          </a>
        </div>
